...
const CAPABILITY_DEFINITIONS = Object.freeze([
  ...
  },
  {
    ...
    universe: "wealth",
    name: "Real Estate Growth OS & Performance Engine",
    description: "End-to-end real estate lead deduplication, explainable 0-100 scoring, site visit lifecycle, and booking attribution.",
    confidenceScore: 94,
    requiredSkills: ["Lead Scoring", "Inventory Modeling", "Site Visit Orchestration", "Real Estate Analytics"],
    requiredTools: ["node", "fs"],
    estimatedDeliveryTime: "2-8 hours",
    pricingGuidance: { minimumFeeUSD: 500, billingModel: "fixed_deliverable" },
    humanApprovalRequired: true,
    canMotherExecuteAutonomously: true,
    dependencies: ["automation.workflow-automation"],
    relatedCapabilities: ["commercial.lead-qualification", "creative.studio_orchestration"],
    tags: ["real estate", "property", "developer", "inventory", "site visit", "booking", "leads", "housing", "bhk", "villa", "apartment", "jaipur", "rera", "growth os"],
    commercializable: true,
    executionMode: "founder_authorized_supervised",
    humanIdentityRequired: false,
    evidenceFiles: ["src/services/realEstateGrowthService.js"]
  },
  {
    id: "creative.studio_orchestration",
    category: "Creative Services",
    universe: "creative",
    name: "Creative Studio Orchestration & IdentityLock™",
    description: "Multi-channel creative brief generation, high-converting ad copy angles, storyboards, and sovereign brand consistency enforcement.",
    confidenceScore: 92,
    requiredSkills: ["Creative Direction", "Ad Copywriting", "IdentityLock Protocol", "Multimodal Orchestration"],
    requiredTools: ["node", "fs"],
    estimatedDeliveryTime: "1-4 hours",
    pricingGuidance: { minimumFeeUSD: 250, billingModel: "fixed_deliverable" },
    humanApprovalRequired: true,
    canMotherExecuteAutonomously: true,
    dependencies: [],
    relatedCapabilities: ["creative.vector-design", "ai.agent-engineering"],
    tags: ["creative", "brief", "ad copy", "storyboard", "identitylock", "brand", "concept", "headline", "hook", "marketing", "campaign"],
    commercializable: true,
    executionMode: "founder_authorized_supervised",
    humanIdentityRequired: false,
